...
if windows:
    plt.axhline(10.45 - E_F_MLWF, linestyle=(0, (5, 5)), linewidth=1, color='b', alpha=1)
    plt.axhline(8.7 - E_F_MLWF, linestyle=(0, (5, 5)), linewidth=1, color='b', alpha=1)
