# Tight-binding hopping integrals for VASP 6.4.2:
# -----------------------------------------------
...
# R = 0 hopping matrix (onsite block)
H0 = (1 / N_k) * t[0]

H00 = H0[0, 0]      # first diagonal element
H44 = H0[4, 4]      # fifth diagonal element
delta = H44 - H00

t_1_x = H0[0, 3]    # 1st row, 4th column
t_2_z = H0[4, 6]    # 5th row, 7th column

outfile = "tb_parameters.txt"

with open(outfile, "w") as f:
    f.write("# Tight-binding parameters (R = 0)\n")
    f.write(f"# delta:\n{delta:.6f}\n")
    f.write(f"# t_1_x:\n{t_1_x:.6f}\n")
    f.write(f"# t_2_z:\n{t_2_z:.6f}\n")
